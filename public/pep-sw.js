!function(e) {
    ...
    3: function(e, t, n) {
        ...
        }, c = "/".concat("shared-worker", ".js"), i = "/".concat("dedicated-worker", ".js"), u = "/".concat("pep-sw-core", ".js"), p = "".concat("pep-sw", ".js"), f = ("/".concat(p), 
        "/".concat("pep-sw"), "https://pep.dev/pep.js"), d = "pausedByPep", a = "pep-sync", s = "pep-navigation", l = /\/_pep_offline/, v = "pep-db", b = "key-val-store";
    },
    99: function(e, t, n) {
        "use strict";
        n.r(t);
