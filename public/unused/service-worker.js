...
let wbStrategies, wbCacheable, wbExpiration, wbBgSync;
...
async function precacheAssets() {
  ...
  // FIX: allSettled wraps results in { status, value } — access via .value
...
async function initStrategies() {
  ...
  const cacheablePlugin = new wbCacheable.CacheableResponsePlugin({ statuses: [0, 200] });
